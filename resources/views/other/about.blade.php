        ...
        <div class="container">
          <div class="row gap-y">
            ...
            <div class="col-md-4">
              <div class="row">
                <div class="col-6">
                  <h4 class="lead-7 text-right counted" data-provide="countup" data-from="0" data-to="100" data-prefix="%">%100</h4>
                </div>
        ...
        <div class="container">
          ...
          <div class="row gap-y">
            <div class="col-md-6 team-2">
              <a href="#">
                <img src="https://pbs.twimg.com/profile_images/1067193262501449729/KzfPUhH6_400x400.jpg" class="rounded-circle" style="height:100px" alt="...">
              </a>
              <h5>Jess Wallace</h5>
            ...
            <div class="col-md-6 team-2">
              <a href="#">
              <img src="https://pbs.twimg.com/profile_images/1064489270331740160/TmgqA2cx_400x400.jpg" class="rounded-circle" style="height:100px" alt="...">
              </a>
              <h5>Ben Wallace</h5>
