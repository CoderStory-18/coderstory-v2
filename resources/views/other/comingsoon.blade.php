...
<body data-aos-easing="ease" data-aos-duration="1500" data-aos-delay="0" class="">
    ...
    <!-- Header -->
    <header class="header text-white h-fullscreen pb-5 pswp__scroll-wrap" style="background-image: url(../img/bg.jpg)">
                        ...
                        <form action="https://builtbyher.us19.list-manage.com/subscribe/post?u=3757dc73cf7e45a04dddc18bd&amp;id=70b2a3e203"
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-append">
                                    <button class="btn btn-glass btn-light" type="submit">Notify me <i class="ti-arrow-right fs-9 ml-3"></i></button>
                                </span>
                            </div>
                        </form>
                    </div>
        ...
        <img src="../assets/img/preview/phone-2.png" alt="..." data-aos="slide-up" class="aos-init">
      </div> -->
